...
Diferente do conteúdo de fundamentos, o objetivo deste conteúdo exclusivo não é somente a leitura(visualização das sintaxes), mas também possibilitar a execução dos códigos através de simulações reais utilizando o servidor local. Para isto:
...
* PHP 8.x
* MySQL
* Servidor local (XAMPP, Laragon ou Servidor Embutido do PHP)
